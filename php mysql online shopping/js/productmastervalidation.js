  //function Validation for Product Master page!!
  function done(){
  // validating Product ID for non empty !!
  ...
  // validating Product Short name for non empty !!
  ...
  // validating Product Long name for non empty !!
  ...
  // validating Product Size for non empty & isNum();!!
  ...
  // return false;
  //}
  // validating Product Quantity for non empty & isNum(); !!
  ...
  // validating Product Quantity available for non empty & isNum();!!
  ...
  // validating Product color for non empty & isCharComa(); !!
  ...
  // validating Product Features for non empty !!
 ...
 // validating Product Sub Category is selected or not!!
  ...
  // validating Product delivary leadtime available for non empty!!
